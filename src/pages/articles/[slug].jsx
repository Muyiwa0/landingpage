  ...
  const supportLinks = [
    {
      ...
      links: [
        ...
        },
        {
          ...
          answer: '',
          answer: `Please pay by transferring into our FirstBank Account: Enovation Concept 3075036936
          `,
          more0: `Alternatively, you can pay on the website: ft9ja.com`,
          more1: `Finally, you can pay securely online using PayPal: Pay Here`,
      ...
      links: [
        {
          ...
          `,
          more1: `We have accounts with third-party Brokers which we give our Traders access to.`,
          link: '/articles/are-you-a-broker',
        },
        {
          id: 2,
          title: 'Is this an investment offer?',
          answer: `No. You are not “investing” any money into our company or into any trading account.
          `,
          more1: `At FT9ja, we invest our funds into talented, profitable, and reliable Traders. We discover our AsoRock Traders by onboarding them through an evaluation process. Traders get paid even during the onboarding period!
          `,
        ...
        },
        {
          ...
          Upon signing up, Our Traders get to choose if they would like to get paid weekly or monthly, this payout frequency continues even on the Aso accounts.
          `,
        ...
        },
        {
          ...
          Note: Second chance accounts only apply to the Classic Model.
          `,
        ...
        },
        {
          ...
          answer: `Answer: No, it hasn’t. When you fail to meet the minimum trading day rule, you are required to trade for an additional week or weeks depending on the number of days missed. This time around, make sure to abide by the rule which says a minimum of 2 days a week and 10 days in a month, you must trade.
          `,
        ...
        },
        {
          ...
          answer: `We have a very vibrant community of Traders where topics like: 
          Beginner Education
          Fundamental Analysis
          Indicators and Price Action
          Trading Systems and Strategies.
          Are discussed and deliberated, this community is one which will go a long way in improving your trading experience with FT9ja.
          `,
      ...
      links: [
        {
          ...
          $3,000, $5,000 and $25,000.
          We also have 3 account sizes for the FT9ja Challenge Model:
        ...
        },
        {
          ...
          answer: `Yes, you can purchase multiple Zuma accounts and request that they be merged into a single account.
           Note: On the FT9ja Challenge Model you can only have one account. 
           `,
        ...
        },
        {
          ...
          answer: `If you choose the weekly payout option, you get paid out every week and if you choose the monthly payout option then you get paid every 4 weeks. 
           Note: Payouts are processed on Fridays ONLY.
           `,
        ...
        },
        {
          ...
          answer: `You will be paid 5% of your profits every week if you are on the weekly payout plan or 10% of your profits every four weeks if you choose to be paid monthly.
           Note: The maximum Talent Bonus is 5% of your account size.
           `,
        ...
        },
        {
          ...
          answer: `You earn:
           80% Profit Split if you qualify for the Aso Account within 1 month of placing your first trade. 
           60% Profit Split if you qualify for the Aso Account within 1-3 months and
      ...
      links: [
        {
          ...
          answer: `You are required to open and close trading positions for 2 or more separate days in a trading week. In addition, you are required to trade 10 or more separate days in a trading month. 
          For FT9ja Challenge and verification, you are required to trade for 6 or more days in each stage.
          Trading days do not need to be consecutive.
          No maximum amount of trades.
          `,
        ...
        },
        {
          ...
          answer: `Signals and Expert Advisors are allowed! Just make sure the robot is not breaking any of our rules.
        ...
        },
        {
          ...
          answer: `There are no restrictions on trading styles.
      ...
      links: [
        {
          ...
          Email Address: info@ft9ja.com 
          Whatsapp: +2348138462394
          We’re only a dm away on both Facebook and Instagram.
          Facebook: @ft9ja
          Instagram: @ft9ja.official
          We also have our offices in Abuja and Lagos. You can book an appointment on calendly.com/ft9ja for our Abuja office or calendly.com/ft9ja-lagos for our Lagos office.
        ...
        },
        {
          ...
          answer: `We sincerely appreciate this and because of how much value we place on the input of our community members we have a designated email address for those suggestions or complaints.
          makeft9jabetter@ft9ja.com
          Simply send your suggestions and complaints to the mail provided above and they will be addressed accordingly.
          `,
