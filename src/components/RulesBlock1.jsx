...
import img from '../images/losss.png'
      ...
      <motion.div {...Animations}>
        <div className="mx-auto grid max-w-screen-lg grid-cols-1 md:grid-cols-2">
          ...
          <div>
            ...
            <br />
            This means that your trading account balance or equity should not go below
5% of the days starting equity. For example, your starting equity for the day
is $5,100. 5% of $5,100 is $255 which means that your equity must not go
below $4,845.
            </p>
            <br />
            <p>
